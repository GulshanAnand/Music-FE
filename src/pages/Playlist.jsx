...
const Playlist = () => {
    ...
    const RemoveFromPlaylist = async (key, videoUrl) => {
        try {
            ...
            <div>
              {
                results.map((item, key) => (
                  <MusicItem key={key} item={item} setTrackName={setTrackName} setTrackUrl={setTrackUrl} RemoveFromPlaylist={RemoveFromPlaylist}/>
                ))}
            </div>
          ) : (
            <p>Playlist Empty</p>
